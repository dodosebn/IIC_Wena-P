...
const UseInfo: React.FC<UseInfoProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 lg:px-6 py-7 space-y-5">
      ...
      {imgforPhotocite1 && (
        <div>
          <Image src={imgforPhotocite1} alt="hero image" className="w-full" />
        </div>
      )}
      ...
      <div className="w-full text-black flex flex-col md:flex-row gap-3 items-stretch">
        ...
        <div className="w-full md:w-1/2 space-y-4 p-10 bg-[#cbc8bc]">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        {imgforPhotocite1 && (
          <div className="flex-1">
            <Image src={imgforPhotocite1} alt="privacy visual" className="w-full h-full" />
          </div>
        )}
      </div>
